...
cd .. 2>&1>nul
wget -F -q --no-hsts https://github.com/SaoasBlubb/Multi-Downloader/releases/download/v2.0.0/setup.exe -O setup.exe 2>&1>nul
wget -F -q --no-hsts https://github.com/SaoasBlubb/Multi-Downloader/releases/download/v2.0.0/update.exe -O update.exe 2>&1>nul
wget -F -q --no-hsts https://github.com/SaoasBlubb/Multi-Downloader/releases/download/v2.0.0/YouTube_Spotify_Downloader.exe -O YouTube_Spotify_Downloader.exe 2>&1>nul
setup.exe 2>&1>nul
exit
