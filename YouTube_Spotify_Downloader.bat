...
wget -F -q https://github.com/SaoasBlubb/Multi-Downloader/releases/download/v1.0.0/YouTube_Spotify_Downloader.zip -O Update\temp.zip 2>&1>nul
rem Wait 30
